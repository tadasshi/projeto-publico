Rails.application.routes.draw do
  ...
  namespace :user, as: :user, :path => 'usuario' do
    ...
    post 'institution_payment/create', to: 'institution_payment#create'
  ...
  # Instituições
  resources :institutions, :path => 'instituicao', only: [:index, :show]
