...
RSpec.describe BibliographiesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all bibliographies as @bibliographies" do
      ...
      expect(assigns(:bibliographies)).to eq([bibliography])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested bibliography as @bibliography" do
      ...
      expect(assigns(:bibliography)).to eq(bibliography)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new bibliography as @bibliography" do
      ...
      expect(assigns(:bibliography)).to be_a_new(Bibliography)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created bibliography as @bibliography" do
        post :create, {:bibliography => valid_attributes}, valid_session
        expect(assigns(:bibliography)).to be_a(Bibliography)
        expect(assigns(:bibliography)).to be_persisted
      end

      it "redirects to the created bibliography" do
        post :create, {:bibliography => valid_attributes}, valid_session
        expect(response).to redirect_to(Bibliography.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved bibliography as @bibliography" do
        post :create, {:bibliography => invalid_attributes}, valid_session
        expect(assigns(:bibliography)).to be_a_new(Bibliography)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested bibliography" do
        bibliography = Bibliography.create! valid_attributes
        put :update, {:id => bibliography.to_param, :bibliography => new_attributes}, valid_session
        bibliography.reload
      ...
      it "redirects to the bibliography" do
        bibliography = Bibliography.create! valid_attributes
        put :update, {:id => bibliography.to_param, :bibliography => valid_attributes}, valid_session
        expect(response).to redirect_to(bibliography)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the bibliography as @bibliography" do
        bibliography = Bibliography.create! valid_attributes
        put :update, {:id => bibliography.to_param, :bibliography => invalid_attributes}, valid_session
        expect(assigns(:bibliography)).to eq(bibliography)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the bibliographies list" do
      bibliography = Bibliography.create! valid_attributes
      delete :destroy, {:id => bibliography.to_param}, valid_session
      expect(response).to redirect_to(bibliographies_url)
    end
  end
