...
RSpec.describe BiographiesController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all biographies as @biographies" do
      ...
      expect(assigns(:biographies)).to eq([biography])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested biography as @biography" do
      ...
      expect(assigns(:biography)).to eq(biography)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new biography as @biography" do
      ...
      expect(assigns(:biography)).to be_a_new(Biography)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created biography as @biography" do
        post :create, {:biography => valid_attributes}, valid_session
        expect(assigns(:biography)).to be_a(Biography)
        expect(assigns(:biography)).to be_persisted
      end

      it "redirects to the created biography" do
        post :create, {:biography => valid_attributes}, valid_session
        expect(response).to redirect_to(Biography.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved biography as @biography" do
        post :create, {:biography => invalid_attributes}, valid_session
        expect(assigns(:biography)).to be_a_new(Biography)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested biography" do
        biography = Biography.create! valid_attributes
        put :update, {:id => biography.to_param, :biography => new_attributes}, valid_session
        biography.reload
      ...
      it "redirects to the biography" do
        biography = Biography.create! valid_attributes
        put :update, {:id => biography.to_param, :biography => valid_attributes}, valid_session
        expect(response).to redirect_to(biography)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the biography as @biography" do
        biography = Biography.create! valid_attributes
        put :update, {:id => biography.to_param, :biography => invalid_attributes}, valid_session
        expect(assigns(:biography)).to eq(biography)
      end
