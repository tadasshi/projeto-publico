...
RSpec.describe EbooksController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all ebooks as @ebooks" do
      ...
      expect(assigns(:ebooks)).to eq([ebook])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested ebook as @ebook" do
      ...
      expect(assigns(:ebook)).to eq(ebook)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created ebook as @ebook" do
        post :create, {:ebook => valid_attributes}, valid_session
        expect(assigns(:ebook)).to be_a(Ebook)
        expect(assigns(:ebook)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved ebook as @ebook" do
        post :create, {:ebook => invalid_attributes}, valid_session
        expect(assigns(:ebook)).to be_a_new(Ebook)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested ebook" do
        ebook = Ebook.create! valid_attributes
        put :update, {:id => ebook.to_param, :ebook => new_attributes}, valid_session
        ebook.reload
      ...
      it "redirects to the ebook" do
        ebook = Ebook.create! valid_attributes
        put :update, {:id => ebook.to_param, :ebook => valid_attributes}, valid_session
        expect(response).to redirect_to(ebook)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the ebook as @ebook" do
        ebook = Ebook.create! valid_attributes
        put :update, {:id => ebook.to_param, :ebook => invalid_attributes}, valid_session
        expect(assigns(:ebook)).to eq(ebook)
      end
